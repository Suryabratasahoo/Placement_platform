...
import { Flame, Award, TrendingUp, Users, MoreHorizontal, Star, Zap, Briefcase } from "lucide-react"
...
export default function StudentApplicationsPage() {
    ...
    // Changed to Application Statuses
    const pieData = [
        { label: "PENDING", value: 45, color: "#818cf8" },
        { label: "OA STAGE", value: 25, color: "#fb923c" },
        { label: "INTERVIEW", value: 15, color: "#93c5fd" },
        { label: "OFFER", value: 5, color: "#facc15" },
        { label: "REJECTED", value: 10, color: "#f472b6" },
    ];
    ...
    const barData = [
        { day: 'Mon', percentage: 60, val: 3 },
        { day: 'Tue', percentage: 30, val: 1 },
        { day: 'Wed', percentage: 90, val: 5, active: true },
        { day: 'Thu', percentage: 45, val: 2 },
        { day: 'Fri', percentage: 55, val: 4 }
    ];
    ...
    return (
        ...
        >
            ...
            <div className="lg:col-span-3 flex flex-col gap-4">
                <div className="bg-[#681cf5] rounded-[40px] p-8 relative overflow-hidden h-64 flex flex-col justify-between shadow-lg">
                    <div className="z-10">
                        ...
                        <h2 className="text-white text-3xl font-bold leading-tight">Actively <br /> Interviewing</h2>
                    </div>
                    <div className="z-10 flex items-center gap-3 bg-white/20 backdrop-blur-md rounded-2xl p-3 w-fit">
                        <Zap size={20} fill="white" className="text-white" />
                        <span className="text-white font-bold text-sm">3 Upcoming OAs</span>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    {[
                        { label: "Applied", value: 42, color: "bg-[#fdecdb]", iconColor: "#e67b2f", icon: <Briefcase size={16}/> },
                        { label: "Shortlisted", value: 12, color: "bg-[#e2e0f7]", iconColor: "#681cf5", icon: <Star size={16}/> },
                    ].map((s, i) => (
                ...
                <div className="bg-[#0c0c0c] rounded-[40px] p-6 flex items-center justify-between shadow-xl mt-auto">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-white font-bold text-lg">5 Day Streak</p>
                            <p className="text-orange-200/60 text-xs uppercase tracking-widest font-bold">Applications</p>
                        </div>
                    </div>
            ...
            {/* === RIGHT COLUMN === */}
            <div className="lg:col-span-9 bg-[#f5f5f5] rounded-[50px] p-10 flex flex-col gap-6 overflow-y-auto scrollbar-none [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                ...
                <div className="bg-[#FFA365] rounded-[45px] p-10 relative">
                    <div className="flex gap-12 mb-10 relative z-10 text-black font-sans">
                        <h3 className="text-4xl font-bold">14 <span className="text-lg font-medium opacity-70">apps sent</span></h3>
                        <h3 className="text-4xl font-bold">3 <span className="text-lg font-medium opacity-70">responses</span></h3>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white rounded-[40px] p-8 shadow-sm border border-gray-50 flex flex-col justify-between">
                        <div className="flex justify-between items-center mb-6">
                            <h3 className="font-bold text-lg text-gray-800">Application Velocity</h3>
                    ...
                    <div className="bg-white rounded-[40px] p-8 shadow-sm border border-gray-50 flex flex-col items-center relative overflow-hidden">
                        <div className="flex justify-between w-full mb-2">
                            <h3 className="font-bold text-lg text-gray-800">Pipeline Health</h3>
                        </div>
                        ...
                        <div className="relative w-56 h-56 mt-2">
                            ...
                            <div className="absolute inset-0 pointer-events-none font-bold text-[9px] tracking-tight text-gray-700">
                                <span className="absolute bottom-[4%] left-1/2 -translate-x-1/2">PENDING (45%)</span>
                                <span className="absolute top-[45%] left-[-10%]">OA (25%)</span>
                                <span className="absolute top-[10%] left-[10%]">INT (15%)</span>
                                <span className="absolute top-[5%] right-[15%]">OFFER</span>
                                <span className="absolute top-[35%] right-[-8%]">REJ</span>
                            </div>
                        </div>

...
export default function QuestionsFeedPage() {
    ...
    ">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    ...
                    {questions.map((q, i) => (
                        <motion.div
                            ...
                            className="relative h-56 bg-[#0c0c0c] rounded-[40px] p-6 overflow-hidden shadow-xl group"
                        >
                            ...
                            <div className="flex justify-between relative z-10">
                                ...
                                <button className="w-9 h-9 bg-[#4e5055] rounded-full text-white flex items-center justify-center">
                                    ⋯
                                </button>
                            </div>
        ...
        "
            ...
            {/* ================= RIGHT (UNCHANGED DASHBOARD PANEL) ================= */}
            {/* ================= RIGHT PANEL ================= */}
            {/* ================= RIGHT PANEL ================= */}
<div className="lg:col-span-3 
    ...
    pb-8"> {/* Added bottom padding for better scroll end-feel */}

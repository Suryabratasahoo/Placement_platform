...
// Updated menu items with correct routes and IDs
const menuItems = [
  { id: 'dashboard', label: 'Dashboard', icon: Home, path: '/senior' },
  { id: 'queries', label: 'Queries', icon: MessageSquare, path: '/senior/queries' },
  { id: 'experiences', label: 'Experiences', icon: Briefcase, path: '/senior/experiences' },
  { id: 'analytics', label: 'Analytics', icon: BarChart3, path: '/senior/analytics' },
  { id: 'settings', label: 'Settings', icon: Settings, path: '/senior/settings' },
];
